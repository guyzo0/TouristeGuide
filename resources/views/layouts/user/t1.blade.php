			   			...
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1>Intelligent Tourist Guide</h1>
									<h2></a>Due to its geographical peculiarities (relief, climate, fauna and flora, peoples and traditions),
								 ...
								 visa in which case we will not enter the territory.
								 <p> click below to see the categories of tourist sites in Cameroon</p></h2>
									<p><a class="btn btn-primary btn-lg" href="{{ route('tcategory')}}">Click here</a></p>
			   				</div>
			   			</div>
			   		</div>
		   		</div>
